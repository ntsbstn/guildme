    <!-- START HEADER -->
      <div class="header ">
        ...
        <div class=" pull-right">
          <!-- START User Info-->
          <div class="visible-lg visible-md m-t-10">
          @if (\Route::current()->getName() == 'show-character')

          <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
              <span class="semi-bold"><a href="{{ route('update-character',  Request::segment(2))  }}"<span class="fa fa-bubble"></span>Update</a></span>
          </div>
          @endif
            <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
              <span class="semi-bold">{{ Sentinel::getUser()->username }}</span>
            </div>
            <div class="dropdown pull-right">
              ...
              <ul class="dropdown-menu profile-dropdown" role="menu">
                <li><a href="{{ route('edit-user') }}"><i class="pg-settings_small"></i> Edit account</a>
                </li>
