       ...
       <hr>
        <?php if(count($myCharacters) > 0): ?>
          ...
          <?php $__currentLoopData = $myCharacters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myChar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <li class="col-xs-6 col-sm-4 col-md-2"><a href="<?php echo e(route('show-character', ['id' => $myChar['id']])); ?>"><img src="https://render-eu.worldofwarcraft.com/character/<?php echo e($myChar['thumbnail']); ?>"><br><?php echo e($myChar['name']); ?></a></li>
